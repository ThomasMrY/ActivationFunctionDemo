...
parser.add_argument("AF",choices=['tanh','selu','self_define'], help="The activation function you want to implement(tanh,selu,self_define)",type=str)
parser.add_argument("rang_l", help="The range of the AF you want to implement(right endpoint)",type=float)
parser.add_argument("rang_r", help="The range of the AF you want to implement(right endpoint)",type=float)
